...
te.goto(0,0)
drawSVG(te, str(savedir / "svg_with_c.svg"), 250, 400, fill=False, outline=True)


# save 
te.save(str(savedir / "c.exp"))
te.save(str(savedir / "c.png"))

# visualize final product .png with PIL haha 
from PIL import Image 
Image.open(str(savedir / "c.png")).show() 
